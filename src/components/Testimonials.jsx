...
export default function Testimonials() {
    return (
        <section className='w-full flex justify-center pt-16 mb-16 lg:mb-32 bg-bgDark2 relative'>
            <div className='absolute -top-16' id='feedback'></div>
            <div className='flex flex-col w-full lg:w-[1150px] justify-center'>
                ...
                >
                    <div className='block-subtitle text-center mb-6'>Testimonial</div>
                    <div className='block-big-title capitalize text-center mb-20 px-8 sm:px-24 md:px-48'>
                        People like you love AstroJS.
                    </div>

                    <div className='flex flex-col lg:flex-row gap-8 lg:gap-5 xl:gap-10 px-6 xl:px-0 items-center'>
                        {testimonialsData.map((testimonial, index) => (
                            <div className='w-11/12 sm:w-4/5 md:w-[560px] lg:w-1/3 main-border-gray-darker rounded-xl bg-bgDark3 flex flex-col px-6 py-4'
